...
class PendulumParameters {
 public:
  ...
  double point_mass_radius() const { return 0.02 * std::pow<double>(mass_, 1.0 / 3); }
  // Radius of the cylinder used to visualize the massless rod
  double massless_rod_radius() const { return 0.005; }
...
std::unique_ptr<multibody::MultibodyPlant<double>> MakePendulumPlant(
